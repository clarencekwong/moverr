...
class FurnituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create furniture" do
    assert_difference('Furniture.count') do
      post furnitures_url, params: { furniture: { category: @furniture.category, description: @furniture.description, job_id: @furniture.job_id, name: @furniture.name, user_id: @furniture.user_id } }
    end
  ...
  test "should update furniture" do
    patch furniture_url(@furniture), params: { furniture: { category: @furniture.category, description: @furniture.description, job_id: @furniture.job_id, name: @furniture.name, user_id: @furniture.user_id } }
